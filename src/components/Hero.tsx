  ...
  return (
    <div className="relative w-full h-screen overflow-hidden ">
      ...
      <div className="w-full pl-4 sm:pl-8 md:pl-[120px] mx-auto md:mx-0 text-center md:text-left mt-60 sm:mt-60 lg:mt-60">
        ...
        <p className="text-3xl font-exo text-gray-300">
          The market moves{" "}
          <span className="font-extrabold text-whiteBackground">fast</span>. Get
          insights <br />
          that{" "}
          <span className="font-extrabold text-whiteBackground">matter</span>,
          from people <br />
          who actually{" "}
          <span className="font-extrabold text-whiteBackground">deliver</span>.
        </p>
      </div>
    </div>
  );
