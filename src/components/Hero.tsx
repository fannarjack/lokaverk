...
const HeroSection = () => {
  return (
    <div className="relative w-full h-screen overflow-hidden ">
      ...
      <Navbar />
      <div className="w-full pl-4 sm:pl-8 md:pl-[120px] mx-auto md:mx-0 text-center md:text-left mt-20 sm:mt-32 lg:mt-40">
        ...
        <div className="my-11 flex gap-6">
          <Link href="/articles">
            <button className="inline-block bg-white text-black px-8 py-4 rounded-md font-semibold hover:bg-gray-200 transition">
              Articles
            </button>
          </Link>
          <Link href="/callers">
